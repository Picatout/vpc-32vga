/*
* Copyright 2013,2107 Jacques Deschênes
...
/*
 * Fichier: QWERTY.c
 * Description: Translate tables from scancode to ASCII for QWERTY keyboard
...
const t_scan2key qwerty[]={  // SCANCODE -> ASCII (QWERTY keyboard)
		{SC_LTR_A,'a'},
		{SC_LTR_B,'b'},
		{SC_LTR_C,'c'},
		{SC_LTR_D,'d'},
