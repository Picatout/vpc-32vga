...
#define KBD_RESET 0xFF  // keyboard reset
#define KBD_LED 0xED    // keyboard LEDs set.

#define XT_BIT	(1<<8)  // extended key flag
#define REL_BIT (1<<15) // key released flag

// keyboard scancodes QWERTY 
...
#define SC_F11			0x78
#define SC_F12			0x07
#define SC_PRN			(XT_BIT|0x12) // PrtSc send 4 codes when down: 0xe0,0x12,0xe0,0x7c 
                                      // 6 codes when released: 0xe0,0xf0,0x7c,0xe0,0xf0,0x12
#define SC_PAUSE		0xe1 // Pause key send 8 codes 0xe1,0x14,0x77,0xe1,0xf0,0x14,0xf0,0x77
...
// keyboard answer
#define KBD_ACK   0xFA   // ACK keyboard positive acknowledge
#define KBD_RSND  0xFE  // keyboard ask for a resend.
#define BAT_OK    0xAA    // Basic Assurance Test OK
#define BAT_ERROR 0xFC // Basic Assurance Test failed


#define KEY_REL 0xF0 // key release code
#define XTD_KEY 0xE0 // extended key code

// flags in rx_flags variable 
#define F_ERROR 1 // keyboard error parity or other.
#define F_RCVD 2 // code received
#define F_BATOK 4 // keyboard sent BAT_OK
#define F_ACK   8 // keyboard sent ACK

// flags in kbd_leds variable
#define F_SCROLL 1 // scroll lock LED on
#define F_NUM  2 // numlock LED on
#define F_CAPS 4 // caps lock LED on
// flags in key_state variable
#define F_LSHIFT 8  // left shift down
#define F_RSHIFT 16 // right shift down
#define F_SHIFT (F_LSHIFT|F_RSHIFT)
#define F_LCTRL 32  // left control down
#define F_RCTRL 64  // right control down
#define F_CTRL (F_LCTRL|F_RCTRL)
#define F_LALT 128 // left alt down
#define F_ALTCHAR  256 // right alt down
